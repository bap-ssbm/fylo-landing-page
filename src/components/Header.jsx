...
const Header = () => {
    return (
        <motion.div className="header" initial={{ opacity: 0, y: -20 }}
            ...
            <div className="logo">
                <motion.svg width="176" height="52" xmlns="http://www.w3.org/2000/svg">
                    <g fill="#FFF" fill-rule="evenodd">
                        <motion.path initial={{ pathLength: 0 }}
                            ...
                            animate={{ pathLength: 1 }} transition={{duration: 4, yoyo: Infinity, ease: "easeInOut" }} />
                    </g>
                </motion.svg>
            </div>
            <div className="nav-section">
                <motion.a className="nav-item" whileHover={{ textDecoration: "underline", scale: 1.1 }} >
                    Features
                </motion.a>
                <motion.a className="nav-item" whileHover={{ textDecoration: "underline", scale: 1.1 }}>
                    Team
